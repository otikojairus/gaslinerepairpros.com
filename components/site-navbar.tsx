  ...
  return (
    <>
      <header className="pulse-header">
        <div className="pulse-wrap pulse-nav">
          <Link href="/" className="pulse-brand" aria-label={SITE_NAME} onClick={() => setOpen(false)}>
            <img src="/logo.svg" alt="Gas Line Repair Pros logo" width={38} height={38} className="pulse-brand-mark" />
            <span>{SITE_NAME}</span>
          </Link>
          ...
          <a className="pulse-call pulse-call-desktop" href={`tel:${PHONE_DISPLAY.replace(/[^0-9]/g, "")}`}>
            Call {PHONE_DISPLAY}
          </a>
          <button
            type="button"
